...
class Ex02_WordStatAnswer {
    ...
    // ── 문제 3 답안 ───────────────────────────────────────────────────────────
    /**
     * toLowerCase 후 chars()로 IntStream 변환
    ...
    void test_countVowels() {
        assertThat(countVowels("Hello World")).isEqualTo(3);
        assertThat(countVowels("Java")).isEqualTo(2);
        assertThat(countVowels("AEIOU")).isEqualTo(5);
    }

    // ── 문제 4 답안 ───────────────────────────────────────────────────────────
    /**
     * split으로 단어 분리 후 각 단어를 StringBuilder.reverse()로 뒤집기
    ...
    void test_longestWord() {
        ...
        assertThat(longestWord("cat bat hat")).isEqualTo("cat");
    }
     ...
     * StringBuilder로 결과 누적, String.join으로 공백 삽입
     */
